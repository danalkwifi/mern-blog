        ...
        <Footer container className="border border-t-8 border-teal-500">
            <div className="w-full max-w-7xl mx-auto">
                <div className="grid w-full justify-between sm:flex md:grid-cols-1">
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://www.100jsprojects.com' target='_blank' rel='noopner noreferrer'>
                                100 JS Projects
                            </Footer.Link>
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://www.github.com' target='_blank' rel='noopner noreferrer'>
                                Github
                            </Footer.Link>
                            <Footer.Link href='#'>
                                Discord
                ...
                <div className="w-full sm:flex sm:items-center sm:justify-between">
                    <Footer.Copyright href='#' by="Dana Al-Kwifi" year={new Date().getFullYear()} />
